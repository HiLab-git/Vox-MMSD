...
class NormalizeWithMinMax(AbstractTransform):
    ...
    def __init__(self, params):
        ...
        self.chns = params.get('NormalizeWithMinMax_channels'.lower(), None)
        self.thred_lower = params.get('NormalizeWithMinMax_threshold_lower'.lower(),None)
        self.thred_upper = params.get('NormalizeWithMinMax_threshold_upper'.lower(),None)
    ...
    def __call__(self, sample):
        ...
        for i in range(len(chns)):
            ...
            if(v1!=v0):
                ...
                print('Image {} got a max value of {}, and a min value of {} after random resized crop.'.format(sample['names'][chn],v1,v0))
            image[chn] = img_chn
        sample['image'] = image
        return sample
