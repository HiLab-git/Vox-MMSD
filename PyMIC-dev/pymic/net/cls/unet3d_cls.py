...
class UNet3D_CLS(nn.Module):
    ...
    * Reference: Özgün Çiçek, Ahmed Abdulkadir, Soeren S. Lienkamp, Thomas Brox, Olaf Ronneberger:
    ...
    """
    def __init__(self, params):
        super(UNet3D_CLS, self).__init__()
        ...
        self.avg = nn.AdaptiveAvgPool3d(output_size=(1,1,1))
        self.fc = nn.Linear(in_features=params['feature_chns'][-1], out_features=params['class_num'], bias=True)
